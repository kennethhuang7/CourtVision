...
rateLimiter.configure('supabase-query', { maxRequests: 2000, windowMs: 60000 });
rateLimiter.configure('supabase-mutation', { maxRequests: 500, windowMs: 60000 });
rateLimiter.configure('filter-change', { maxRequests: 50, windowMs: 1000 });
rateLimiter.configure('date-change', { maxRequests: 30, windowMs: 1000 }); 
