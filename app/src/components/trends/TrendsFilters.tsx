...
export function TrendsFilters({ filters, updateFilter, onClose }: TrendsFiltersProps) {
  ...
  return (
    <div className="bg-card border-b border-border/60 p-6 animate-in fade-in slide-in-from-top-2 duration-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <select
                ...
                className="w-full bg-secondary border border-border/80 rounded-lg px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
              >
                {statTypes.map(type => (
            ...
            <div className="flex items-end pb-2">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  ...
                  className="w-4 h-4 bg-secondary border-border/80 rounded text-primary focus:ring-2 focus:ring-primary"
                />
                <span className="text-sm font-medium text-muted-foreground">AI Agreement</span>
              </label>
            </div>
          </div>
        </div>
              ...
              {statTypes.slice(1).map(type => ( 
                <div key={type.value}>
                  ...
                  <input
                    ...
                    className="w-full bg-secondary border border-border/80 rounded px-2 py-1 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                    placeholder="0.0"
                  />
                </div>
              ))}
